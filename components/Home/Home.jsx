...
import { homeCards, ourPartners } from "./services";
const { Meta } = Card;
    ...
    <>
      ...
      <Row>
        <Col span={24}>
          ...
          <Row className="padding-left-right-50 flex align-center justify-center margin-top-100px">
            ...
            {homeCards.map((productCard, index) => {
              return (
                <>
                  <Col span={8} className="flex align-center justify-center">
                    <Card
                      ...
                      actions={[
                        <Button
                          type="primary"
                          onClick={() => handleDetails(productCard.productId)}
                        >
                          Find Out More
                        </Button>,
                      ]}
